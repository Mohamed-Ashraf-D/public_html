                    ...
                    <div class="container m-auto">
                        <div class="bg-white">
                            ...
                            <div class="row m-auto">
                                ...
                                <div class="col-12">
                                    <form class="m-auto" method="POST" action="<?= htmlspecialchars($_SERVER['PHP_SELF'] . '?itemid=' . $item['item_ID']) ?>">
                                        ...
                                        <button class="btn btn-primary mb-3">ارسال التعليق</button>
                                    </form>
                                    <?php if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                        ...
                                        $userId = $_SESSION['uid'];
                                        if (!empty($comment)) {
                                            $stmt = $conn->prepare("INSERT INTO comments(comment,status,comment_date,item_id,user_id) VALUES (:mcomment,0,NOW(),:mitemid,:muserid)");
                                            $stmt->execute(array(
                                                'mcomment' => $comment,
                                                'mitemid' => $itemID,
                                                'muserid' => $userId
                                            ...
                                            if ($stmt) {
                                                $theMsg = '<br><br><br><div class="alert alert-success">Comment Added Successfully</div>';
                                                redirectHome($theMsg, 'back', 0);
                                            }
                                        } else {
                                            echo '<br><br><br><div class="alert alert-danger">Comment must be not empty</div>';
                                        }
                                    }
                                    ?>
                ...
                <section>
                    <div class="container">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link" href="#tab3" data-toggle="tab">تعليقات الطلاب على الشرح</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="#tab1" data-toggle="tab">ملاحظات</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active p-3 " id="tab1">
